# Autogenerated wrapper script for HelloWorldRust_jll for powerpc64le-linux-gnu
export hello_world
...
function __init__()
    ...
    global hello_world_path = abspath(joinpath(artifact"HelloWorldRust", hello_world_splitpath...))
